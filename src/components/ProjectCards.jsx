...
const ProjectCards = ({ project, index }) => {
  return (
    <div className='sticky overflow-hidden rounded-2xl border-2 border-white/15 bg-gray-800 p-8
    md:flex md:items-center' style={{top: `calc(100px + ${index * 30}px)`}}>
        {/* project content */}
        <div className='flex flex-1 flex-col gap-5'>
            ...
            <Button onClick={() => window.open(project.link, '_blank')}>Visit Site</Button>
